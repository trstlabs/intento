...
tppd tx tpp item-resell 0 22 11 Nijmegen be,nl 'watch did not fit me so I resell this watch'  --from=user2 -y --chain-id=tpp --keyring-backend test --fees 150tpp
...
tppd tx tpp item-resell 6 23 22 '40.741895,-73.989308' us,be,nl 'watch did not fit me so I resell this watch'  --from=user2 -y --chain-id=tpp --keyring-backend test --fees 150tpp
