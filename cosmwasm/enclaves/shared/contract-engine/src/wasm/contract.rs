...
/// Contract maps function index to implementation
/// When instantiating a module we give it the ImportResolver resolver
...
impl WasmiApi for ContractInstance {
    ...
    fn addr_canonicalize(
        ...
        self.use_gas_externally(self.gas_costs.external_addr_canonicalize as u64)?;
    ...
    fn addr_humanize(
        ...
        self.use_gas_externally(self.gas_costs.external_addr_humanize as u64)?;
