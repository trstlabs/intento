...
//! Generated file from `item/item.proto`
...
pub struct Params {
    ...
    pub EstimationRatioForNewItem: i64,
    pub CreateItemFee: i64,
...
impl Params {
    ...
    pub fn get_EstimationRatioForNewItem(&self) -> i64 {
        self.EstimationRatioForNewItem
    }
    pub fn clear_EstimationRatioForNewItem(&mut self) {
        self.EstimationRatioForNewItem = 0;
    }

    // Param is passed by value, moved
    pub fn set_EstimationRatioForNewItem(&mut self, v: i64) {
        self.EstimationRatioForNewItem = v;
    }

    // int64 CreateItemFee = 4;


    pub fn get_CreateItemFee(&self) -> i64 {
        self.CreateItemFee
    }
    pub fn clear_CreateItemFee(&mut self) {
        self.CreateItemFee = 0;
    }

    // Param is passed by value, moved
    pub fn set_CreateItemFee(&mut self, v: i64) {
        self.CreateItemFee = v;
    }
...
impl ::protobuf::Message for Params {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                3 => {
                    ...
                    let tmp = is.read_int64()?;
                    self.EstimationRatioForNewItem = tmp;
                },
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.EstimationRatioForNewItem != 0 {
            my_size += ::protobuf::rt::value_size(3, self.EstimationRatioForNewItem, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.CreateItemFee != 0 {
            my_size += ::protobuf::rt::value_size(4, self.CreateItemFee, ::protobuf::wire_format::WireTypeVarint);
        }
        if self.MaxBuyerReward != 0 {
            my_size += ::protobuf::rt::value_size(5, self.MaxBuyerReward, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.EstimationRatioForNewItem != 0 {
            os.write_int64(3, self.EstimationRatioForNewItem)?;
        }
        if self.CreateItemFee != 0 {
            os.write_int64(4, self.CreateItemFee)?;
        }
        if self.MaxBuyerReward != 0 {
            os.write_int64(5, self.MaxBuyerReward)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "EstimationRatioForNewItem",
                |m: &Params| { &m.EstimationRatioForNewItem },
                |m: &mut Params| { &mut m.EstimationRatioForNewItem },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "CreateItemFee",
                |m: &Params| { &m.CreateItemFee },
                |m: &mut Params| { &mut m.CreateItemFee },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "MaxBuyerReward",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0fitem/item.proto\x12\x12trstlabs.trst.trst\x1a\x1fgoogle/protobuf/t\
    imestamp.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x14gogoproto/go\
    go.proto\"\x8a\x03\n\x04Item\x12\x18\n\x07creator\x18\x01\x20\x01(\tR\
    \x07creator\x12\x0e\n\x02id\x18\x03\x20\x01(\x04R\x02id\x12\x14\n\x05tit\
    le\x18\x04\x20\x01(\tR\x05title\x12\x20\n\x0bdescription\x18\x05\x20\x01\
    (\tR\x0bdescription\x12\x16\n\x06status\x18\x06\x20\x01(\tR\x06status\
    \x12>\n\nestimation\x18\x07\x20\x01(\x0b2\x1e.trstlabs.trst.trst.Estimat\
    ionR\nestimation\x12N\n\x10listing_duration\x18\x08\x20\x01(\x0b2#.trstl\
    abs.trst.trst.ListingDurationR\x0flistingDuration\x128\n\x08transfer\x18\
    \t\x20\x01(\x0b2\x1c.trstlabs.trst.trst.TransferR\x08transfer\x12>\n\npr\
    operties\x18\n\x20\x01(\x0b2\x1e.trstlabs.trst.trst.PropertiesR\npropert\
    ies\"\xf9\x02\n\nEstimation\x12)\n\x10estimation_price\x18\x01\x20\x01(\
    \x03R\x0festimationPrice\x12%\n\x0ebest_estimator\x18\x02\x20\x01(\tR\rb\
    estEstimator\x12)\n\x10estimation_count\x18\x03\x20\x01(\x03R\x0festimat\
    ionCount\x12)\n\x10estimation_total\x18\x04\x20\x01(\x03R\x0festimationT\
    otal\x12%\n\x0eestimator_list\x18\x05\x20\x03(\tR\restimatorList\x12'\n\
    \x0festimation_list\x18\x06\x20\x03(\x03R\x0eestimationList\x12\x1a\n\
    \x08comments\x18\x07\x20\x03(\tR\x08comments\x12%\n\x0edeposit_amount\
    \x18\x08\x20\x01(\x03R\rdepositAmount\x12\x1a\n\x08contract\x18\t\x20\
    \x01(\tR\x08contract\x12\x14\n\x05flags\x18\n\x20\x01(\x03R\x05flags\"\
    \x99\x01\n\x0fListingDuration\x12E\n\x0bsubmit_time\x18\x01\x20\x01(\x0b\
    2\x1a.google.protobuf.TimestampR\nsubmitTimeB\x08\x90\xdf\x1f\x01\xc8\
    \xde\x1f\0\x12?\n\x08end_time\x18\x02\x20\x01(\x0b2\x1a.google.protobuf.\
    TimestampR\x07endTimeB\x08\x90\xdf\x1f\x01\xc8\xde\x1f\0\"\x86\x02\n\x08\
    Transfer\x12#\n\rshipping_cost\x18\x01\x20\x01(\x03R\x0cshippingCost\x12\
    \x1a\n\x08location\x18\x02\x20\x01(\tR\x08location\x12\x1a\n\x08tracking\
    \x18\x03\x20\x01(\x08R\x08tracking\x12'\n\x0fshipping_region\x18\x04\x20\
    \x03(\tR\x0eshippingRegion\x12\x16\n\x06rating\x18\x05\x20\x01(\x03R\x06\
    rating\x12\x12\n\x04note\x18\x06\x20\x01(\tR\x04note\x12\x1a\n\x08discou\
    nt\x18\x07\x20\x01(\x03R\x08discount\x12\x14\n\x05buyer\x18\x08\x20\x01(\
    \tR\x05buyer\x12\x16\n\x06seller\x18\t\x20\x01(\tR\x06seller\"\xdb\x01\n\
    \nProperties\x12\x1c\n\tcondition\x18\x01\x20\x01(\x03R\tcondition\x12\
    \x16\n\x06photos\x18\x02\x20\x03(\tR\x06photos\x12\x19\n\x08is_token\x18\
    \x03\x20\x01(\x08R\x07isToken\x12'\n\x0festimation_only\x18\x04\x20\x01(\
    \x08R\x0eestimationOnly\x12\x12\n\x04tags\x18\x05\x20\x03(\tR\x04tags\
    \x12\x1b\n\ttoken_uri\x18\x06\x20\x01(\tR\x08tokenUri\x12\"\n\x0ctransfe\
    rable\x18\x07\x20\x01(\x08R\x0ctransferable\"\xba\x03\n\rMsgCreateItem\
    \x12\x18\n\x07creator\x18\x01\x20\x01(\tR\x07creator\x12\x14\n\x05title\
    \x18\x02\x20\x01(\tR\x05title\x12\x20\n\x0bdescription\x18\x03\x20\x01(\
    \tR\x0bdescription\x12#\n\rshipping_cost\x18\x04\x20\x01(\x03R\x0cshippi\
    ngCost\x12\x1a\n\x08location\x18\x05\x20\x01(\tR\x08location\x12)\n\x10e\
    stimation_count\x18\x06\x20\x01(\x03R\x0festimationCount\x12\x12\n\x04ta\
    gs\x18\x07\x20\x03(\tR\x04tags\x12\x1c\n\tcondition\x18\x08\x20\x01(\x03\
    R\tcondition\x12'\n\x0fshipping_region\x18\t\x20\x03(\tR\x0eshippingRegi\
    ...
    hotos\x12\x1b\n\ttoken_uri\x18\x0e\x20\x01(\tR\x08tokenUri\"\xa1\x01\n\r\
    MsgUpdateItem\x12\x16\n\x06seller\x18\x01\x20\x01(\tR\x06seller\x12\x0e\
    \n\x02id\x18\x02\x20\x01(\x04R\x02id\x12#\n\rshipping_cost\x18\x03\x20\
    \x01(\x03R\x0cshippingCost\x12\x1a\n\x08location\x18\x04\x20\x01(\tR\x08\
    location\x12'\n\x0fshipping_region\x18\x05\x20\x03(\tR\x0eshippingRegion\
    ...
    \x18\x02\x20\x01(\x04R\x06itemid\x12\x1d\n\nreveal_msg\x18\x03\x20\x01(\
    \x0cR\trevealMsg\"p\n\x13MsgItemTransferable\x12\x16\n\x06seller\x18\x01\
    \x20\x01(\tR\x06seller\x12)\n\x10transferable_msg\x18\x02\x20\x01(\x0cR\
    \x0ftransferableMsg\x12\x16\n\x06itemid\x18\x03\x20\x01(\x04R\x06itemid\
    \"]\n\x0fMsgItemShipping\x12\x16\n\x06seller\x18\x01\x20\x01(\tR\x06sell\
    er\x12\x1a\n\x08tracking\x18\x02\x20\x01(\x08R\x08tracking\x12\x16\n\x06\
    itemid\x18\x03\x20\x01(\x04R\x06itemid\"\xd9\x01\n\rMsgItemResell\x12\
    \x16\n\x06seller\x18\x01\x20\x01(\tR\x06seller\x12\x16\n\x06itemid\x18\
    \x02\x20\x01(\x04R\x06itemid\x12#\n\rshipping_cost\x18\x03\x20\x01(\x03R\
    \x0cshippingCost\x12\x1a\n\x08discount\x18\x04\x20\x01(\x03R\x08discount\
    \x12\x1a\n\x08location\x18\x05\x20\x01(\tR\x08location\x12'\n\x0fshippin\
    g_region\x18\x06\x20\x03(\tR\x0eshippingRegion\x12\x12\n\x04note\x18\x07\
    \x20\x01(\tR\x04note\"\xc4\x02\n\x06Params\x12l\n\x0fMaxActivePeriod\x18\
    \x01\x20\x01(\x0b2\x19.google.protobuf.DurationR\x0fMaxActivePeriodB'\
    \xc8\xde\x1f\0\x98\xdf\x1f\x01\xea\xde\x1f\x1bmax_active_period,omitempt\
    y\x12:\n\x18MaxEstimatorCreatorRatio\x18\x02\x20\x01(\x03R\x18MaxEstimat\
    orCreatorRatio\x12<\n\x19EstimationRatioForNewItem\x18\x03\x20\x01(\x03R\
    \x19EstimationRatioForNewItem\x12$\n\rCreateItemFee\x18\x04\x20\x01(\x03\
    R\rCreateItemFee\x12&\n\x0eMaxBuyerReward\x18\x05\x20\x01(\x03R\x0eMaxBu\
    yerReward:\x04\x98\xa0\x1f\0\"9\n\x0fMsgTokenizeItem\x12\x16\n\x06sender\
    \x18\x01\x20\x01(\tR\x06sender\x12\x0e\n\x02id\x18\x03\x20\x01(\x04R\x02\
    id\";\n\x11MsgUnTokenizeItem\x12\x16\n\x06sender\x18\x01\x20\x01(\tR\x06\
    sender\x12\x0e\n\x02id\x18\x03\x20\x01(\x04R\x02idB'Z%github.com/trstlab\
    s/trst/x/item/typesb\x06proto3\
";
