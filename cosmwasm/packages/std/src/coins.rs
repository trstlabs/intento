...
///
/// ```
/// # use trustless_cosmwasm_std::{coins, BankMsg, CosmosMsg, Response, SubMsg};
/// # use trustless_cosmwasm_std::testing::{mock_env, mock_info};
/// # let env = mock_env();
...
///
/// ```
/// # use trustless_cosmwasm_std::{coin, BankMsg, CosmosMsg, Response, SubMsg};
/// # use trustless_cosmwasm_std::testing::{mock_env, mock_info};
/// # let env = mock_env();
/// # let info = mock_info("sender", &[]);
/// let tip = vec![
