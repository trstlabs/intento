...
impl<T> IbcBasicResponse<T> {
    ...
    ///
    /// ```
    /// use trustless_cosmwasm_std::{log, IbcBasicResponse};
    ///
    /// let attrs = vec![
    ///     ("action", "reaction"),
    ///     ("answer", "42"),
    ...
    ///
    /// ```
    /// use trustless_cosmwasm_std::{CosmosMsg, IbcBasicResponse};
    ///
    ...
    ///
    /// ```
    /// use trustless_cosmwasm_std::{SubMsg, IbcBasicResponse};
    ///
...
impl<T> IbcReceiveResponse<T> {
    ...
    ///
    /// ```
    /// use trustless_cosmwasm_std::{log, IbcReceiveResponse};
    ///
    /// let attrs = vec![
    ///     ("action", "reaction"),
    ///     ("answer", "42"),
    ...
    ///
    /// ```
    /// use trustless_cosmwasm_std::{CosmosMsg, IbcReceiveResponse};
    ///
    ...
    ///
    /// ```
    /// use trustless_cosmwasm_std::{SubMsg, IbcReceiveResponse};
    ///
