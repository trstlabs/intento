...
func (s *KeeperTestSuite) TestClaimClaimable() {
	...
	// claim
	s.app.ClaimKeeper.AfterAutoSwap(s.ctx, addr1)
	...
	// claim 2
	s.app.ClaimKeeper.AfterRecurringSend(s.ctx, addr1)
	...
	s.app.ClaimKeeper.AfterAutoSwap(s.ctx, addr2)
	s.app.ClaimKeeper.AfterRecurringSend(s.ctx, addr2)
