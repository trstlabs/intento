...
// source: intento/mint/v1/query.proto
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec4626eeea75937f, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec4626eeea75937f, []int{1}
}
...
func (*QueryAnnualProvisionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec4626eeea75937f, []int{2}
}
...
func (*QueryAnnualProvisionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec4626eeea75937f, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "intento.mint.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "intento.mint.v1.QueryParamsResponse")
	proto.RegisterType((*QueryAnnualProvisionsRequest)(nil), "intento.mint.v1.QueryAnnualProvisionsRequest")
	proto.RegisterType((*QueryAnnualProvisionsResponse)(nil), "intento.mint.v1.QueryAnnualProvisionsResponse")
}

func init() { proto.RegisterFile("intento/mint/v1/query.proto", fileDescriptor_ec4626eeea75937f) }

var fileDescriptor_ec4626eeea75937f = []byte{
	// 382 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/intento.mint.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AnnualProvisions(ctx context.Context, in *QueryAnnualProvisionsRequest, opts ...grpc.CallOption) (*QueryAnnualProvisionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/intento.mint.v1.Query/AnnualProvisions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/intento.mint.v1.Query/Params",
	}
...
func _Query_AnnualProvisions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/intento.mint.v1.Query/AnnualProvisions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "intento.mint.v1.Query",
	...
	Metadata: "intento/mint/v1/query.proto",
}
