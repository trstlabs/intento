...
var (
	...
	ErrHostedFeeLimit                 = errorsmod.Register(ModuleName, 17, "fee limit reached for trustless excution agent")
	...
	ErrInvalidTrustlessExecutionAgent = errorsmod.Register(ModuleName, 34, "invalid msg response")
