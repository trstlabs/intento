...
var (
	...
	pattern_Msg_SubmitFlow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"intento", "intent", "v1beta1", "submit-flow"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_RegisterAccountAndSubmitFlow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"intento", "intent", "v1beta1", "register-account-submit-flow"}, "", runtime.AssumeColonVerbOpt(false)))
