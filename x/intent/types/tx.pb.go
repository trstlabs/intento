...
type MsgSubmitFlow struct {
	...
	TrustlessAgentExecutionConfig *TrustlessAgentExecutionConfig `protobuf:"bytes,10,opt,name=trustless_agent_config,json=trustlessAgentConfig,proto3" json:"trustless_agent_config,omitempty"`
...
type MsgUpdateFlow struct {
	...
	TrustlessAgentExecutionConfig *TrustlessAgentExecutionConfig           `protobuf:"bytes,11,opt,name=trustless_agent_config,json=trustlessAgentConfig,proto3" json:"trustless_agent_config,omitempty"`
	Conditions                    *ExecutionConditions                     `protobuf:"bytes,12,opt,name=conditions,proto3" json:"conditions,omitempty"`
}
...
var fileDescriptor_dd14a86416625ca6 = []byte{
	...
	,
}
...
func (m *MsgSubmitFlow) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TrustlessAgentExecutionConfig != nil {
		{
			size, err := m.TrustlessAgentExecutionConfig.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgSubmitFlow) Size() (n int) {
	...
	if m.TrustlessAgentExecutionConfig != nil {
		l = m.TrustlessAgentExecutionConfig.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	if m.Conditions != nil {
		l = m.Conditions.Size()
...
func (m *MsgSubmitFlow) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TrustlessAgentExecutionConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TrustlessAgentExecutionConfig == nil {
				m.TrustlessAgentExecutionConfig = &TrustlessAgentExecutionConfig{}
			}
			if err := m.TrustlessAgentExecutionConfig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
