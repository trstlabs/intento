...
var (
	...
	pattern_Query_Flow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"intento", "intent", "v1beta1", "flow", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_FlowHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"intento", "intent", "v1beta1", "flow-history", "id"}, "", runtime.AssumeColonVerbOpt(false)))
