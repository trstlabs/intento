...
type ComputeKeeper interface {
	...
	Instantiate(ctx sdk.Context, codeID uint64, creator sdk.AccAddress, msg []byte, autoMsg []byte, label string, deposit sdk.Coins, callbackSig []byte, customDuration time.Duration) (sdk.AccAddress, error)
