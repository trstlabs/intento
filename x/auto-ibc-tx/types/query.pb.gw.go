...
var (
	filter_Query_AutoTxsForOwner_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
var (
	...
	pattern_Query_AutoTxsForOwner_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"auto-ibc-tx", "v1beta1", "auto-txs"}, ""))
)
