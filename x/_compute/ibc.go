	...
	msg := wasmTypes.IBCChannelOpenMsg{
		OpenInit: &wasmTypes.IBCOpenInit{
			Channel: wasmTypes.IBCChannel{
				Endpoint:             wasmTypes.IBCEndpoint{PortID: portID, ChannelID: channelID},
				CounterpartyEndpoint: wasmTypes.IBCEndpoint{PortID: counterParty.PortId, ChannelID: counterParty.ChannelId},
				Order:                order.String(),
				Version:              version,
...
func (i IBCHandler) OnChanOpenAck(
	...
	msg := wasmTypes.IBCChannelConnectMsg{
...
func (i IBCHandler) OnChanCloseInit(ctx sdk.Context, portID, channelID string) error {
	...
	msg := wasmTypes.IBCChannelCloseMsg{
		CloseInit: &wasmTypes.IBCCloseInit{Channel: toWasmVMChannel(portID, channelID, channelInfo)},
	}
...
func (i IBCHandler) OnChanCloseConfirm(ctx sdk.Context, portID, channelID string) error {
	...
	msg := wasmTypes.IBCChannelCloseMsg{
		CloseConfirm: &wasmTypes.IBCCloseConfirm{Channel: toWasmVMChannel(portID, channelID, channelInfo)},
	}
	err = i.keeper.OnCloseChannel(ctx, contractAddr, msg)
	if err != nil {
		return err
...
func toWasmVMChannel(portID, channelID string, channelInfo channeltypes.Channel) wasmTypes.IBCChannel {
	return wasmTypes.IBCChannel{
		Endpoint:             wasmTypes.IBCEndpoint{PortID: portID, ChannelID: channelID},
		CounterpartyEndpoint: wasmTypes.IBCEndpoint{PortID: channelInfo.Counterparty.PortId, ChannelID: channelInfo.Counterparty.ChannelId},
...
func (i IBCHandler) OnRecvPacket(
	...
	msg := wasmTypes.IBCPacketReceiveMsg{Packet: newIBCPacket(packet), Relayer: relayer.String()}
...
func (i IBCHandler) OnAcknowledgementPacket(
	...
	err = i.keeper.OnAckPacket(ctx, contractAddr, wasmTypes.IBCPacketAckMsg{
		Acknowledgement: wasmTypes.IBCAcknowledgement{Data: acknowledgement},
...
func (i IBCHandler) OnTimeoutPacket(ctx sdk.Context, packet channeltypes.Packet, relayer sdk.AccAddress) error {
	...
	msg := wasmTypes.IBCPacketTimeoutMsg{Packet: newIBCPacket(packet), Relayer: relayer.String()}
...
func newIBCPacket(packet channeltypes.Packet) wasmTypes.IBCPacket {
	timeout := wasmTypes.IBCTimeout{
		Timestamp: packet.TimeoutTimestamp,
	}
	if !packet.TimeoutHeight.IsZero() {
		timeout.Block = &wasmTypes.IBCTimeoutBlock{
	...
	return wasmTypes.IBCPacket{
		Data:     packet.Data,
		Src:      wasmTypes.IBCEndpoint{ChannelID: packet.SourceChannel, PortID: packet.SourcePort},
		Dest:     wasmTypes.IBCEndpoint{ChannelID: packet.DestinationChannel, PortID: packet.DestinationPort},
