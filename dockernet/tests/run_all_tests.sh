...
CHAIN_NAME=OSMO TRANSFER_CHANNEL_NUMBER=1 CONNECTION_ID=1 $BATS $INTEGRATION_TEST_FILE
CHAIN_NAME=HOST TRANSFER_CHANNEL_NUMBER=2 CONNECTION_ID=2 $BATS $INTEGRATION_TEST_FILE
