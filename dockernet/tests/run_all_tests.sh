...
CHAIN_NAME=GAIA TRANSFER_CHANNEL_NUMBER=0 CONNECTION_ID=1 HOST_CONNECTION_ID=1 HOST_TRANSFER_CHANNEL="channel-0" $BATS $INTEGRATION_TEST_FILE
...
#CHAIN_NAME=OSMO TRANSFER_CHANNEL_NUMBER=3 CONNECTION_ID=3 HOST_CONNECTION_ID=3384 HOST_TRANSFER_CHANNEL="channel-8676" $BATS $INTEGRATION_TEST_FILE
