...
# echo -e "\n>>> Initial Balances:"
# echo "> Distributor Account [100uinto expected]:"
# $INTO_MAIN_CMD q bank balances stride12lw3587g97lgrwr2fjtr8gg5q6sku33e5yq9wl --denom uinto 

# echo "> Claim Account [5000000000000uinto expected]:"
# $INTO_MAIN_CMD q bank balances stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z --denom uinto
...
# $INTO_MAIN_CMD tx claim create-airdrop gaia GAIA uinto $(date +%s) 40000000 false --from distributor-test -y | TRIM_TX
# sleep 5
# # Set airdrop allocations
# $INTO_MAIN_CMD tx claim set-airdrop-allocations gaia stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z 1 --from distributor-test -y | TRIM_TX
# sleep 5
# # Check eligibility
# echo "> Checking claim elibility, should return 1 claim record:"
# $INTO_MAIN_CMD q claim claim-record gaia stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z

# #     # BATCH 1
# #     # 3. Check eligibility and claim the airdrop
# echo -e "\n>>> Claiming airdrop"
# $INTO_MAIN_CMD tx claim claim-free-amount --from stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z -y | TRIM_TX
# sleep 5
...
# $INTO_MAIN_CMD q claim claim-record gaia stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z | grep claim_record -A 4
# # Check vesting
# echo -e "\n> Verifying funds are vesting [expected: 20uinto]:"
# $INTO_MAIN_CMD q claim user-vestings stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z | grep spendable_coins -A 2
# # Check balance
# echo -e "\n> Verifying balance [expected: 5000000000020uinto]:"
# $INTO_MAIN_CMD q bank balances stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z --denom uinto
...
# $INTO_MAIN_CMD q claim claim-record gaia stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z  | grep claim_record -A 4
# # Check vesting
# echo -e "\n> Verifying the vesting tokens have not changed [expected: 20uinto]:"
# $INTO_MAIN_CMD q claim user-vestings stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z | grep spendable_coins -A 2
# # Check balance
# echo -e "\n> Verifying balance [expected: 5000000000036uinto]:"
# $INTO_MAIN_CMD q bank balances stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z --denom uinto
...
# $INTO_MAIN_CMD q claim user-vestings stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z | grep spendable_coins -A 2
# # Check balance
# echo -e "\n> Verifying balance [expected: 5000000000049uinto]:"
# $INTO_MAIN_CMD q bank balances stride1kwll0uet4mkj867s4q8dgskp03txgjnswc2u4z --denom uinto
