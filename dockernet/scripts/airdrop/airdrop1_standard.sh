...
# # $INTO_MAIN_CMD tx bank send val1 trust1z835j3j65nqr6ng257q0xkkc9gta72gfl340ws 600000uinto --from val1 -y | TRIM_TX
# # sleep 5
# # Fund the airdrop account
# $INTO_MAIN_CMD tx bank send val1 trust1nf6v2paty9m22l3ecm7dpakq2c92ueyue2d5yv 1000000000uinto --from val1 -y | TRIM_TX
# sleep 5
...
# # $INTO_MAIN_CMD tx claim set-airdrop-allocations gaia trust1nf6v2paty9m22l3ecm7dpakq2c92ueyue2d5yv 1 --from distributor-test -y | TRIM_TX
# # sleep 5

# # AIRDROP CLAIMS
# # Check balances before claims
# echo -e "\nInitial balance before claim [1000000000uinto expected]:"
# $INTO_MAIN_CMD query bank balances trust1nf6v2paty9m22l3ecm7dpakq2c92ueyue2d5yv --denom uinto
