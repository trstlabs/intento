...
/// state of the estimationperiod
#[derive(Serialize, Deserialize)]
pub struct State {
    /// address of estimationperiod contract
    pub estimationperiod_addr: HumanAddr,
    /// address of estimationperiod owner
    pub seller: HumanAddr,
    /// code hash and address of sell token contract
    pub sell_contract: ContractInfo,
    /// code hash and address of estimation token contract
   ...
   // pub sell_amount: u128,
    ...
    /// amount of  tokens currently consigned to estimationperiod escrow
 //   pub currently_consigned: u128,
    /// list of addresses of estimators
    pub estimators: Vec<String>,
     /// list of of estimations
     pub estimation_list: Vec<u128>,
    /// true if the estimationperiod is closed
    pub is_completed: bool,
    /// true if all tokens for sale have been consigned to escrow

    pub estimation_price: u128,
}
/*
/// estimation data
#[derive(Serialize, Deserialize)]
