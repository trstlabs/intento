rly chains add --file ./interchain-acc-config/chains/trstdev-1.json trstdev-1

rly chains add --file ./interchain-acc-config/chains/trstdev-2.json trstdev-2
...
rly paths add trstdev-1 trstdev-2 trstdev1-trstdev2 --file ./deployment/ibc/relayer/interchain-acc-config/paths/trstdev1-trstdev2.json
