...
# > docker run -it -p 26657:26657 -p 26656:26656 -v ~/.tppd:/root/.tppd -v ~/.tppd:/root/.tppd enigma tppd init
# > docker run -it -p 26657:26657 -p 26656:26656 -v ~/.tppd:/root/.tppd -v ~/.tppd:/root/.tppd enigma tppd start
