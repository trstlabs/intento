...
sudo sed -i 's/\/tmp\/.tppd:/\/home\/'$1'\/.tppd:/g' /usr/local/bin/secret-node/docker-compose.yaml
sudo sed -i 's/\/tmp\/.tppd:/\/home\/'$1'\/.tppd:/g' /usr/local/bin/secret-node/docker-compose.yaml
...
{
  echo 'alias tppd="docker exec -it secret-node_node_1 tppd"'
  echo 'alias tppd="docker exec -it secret-node_node_1 tppd"'
  echo 'alias show-node-id="docker exec -it secret-node_node_1 tppd tendermint show-node-id"'
  echo 'alias show-validator="docker exec -it secret-node_node_1 tppd tendermint show-validator"'
...
tppd completion > /root/tppd_completion
tppd completion > /root/tppd_completion

docker cp secret-node_node_1:/root/tppd_completion /home/"$1"/tppd_completion
docker cp secret-node_node_1:/root/tppd_completion /home/"$1"/tppd_completion

echo 'source /home/'$1'/tppd_completion' >> /home/"$1"/.bashrc
echo 'source /home/'$1'/tppd_completion' >> /home/"$1"/.bashrc
