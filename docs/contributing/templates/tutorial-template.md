# How To [Build/Create/Do Something] in Trustless Hub
...
[Create an issue](https://github.com/tendermint/Trustless Hub/issues/new/choose) to let us know if you have questions. 
...
- A supported version of [Trustless Hub](https://docs.Trustless Hub.network/). To install Trustless Hub, see [Install Trustless Hub](../Trustless Hub/install.md). 
...
```sh
Trustless Hub --version
```

You'll see release details like the following output:

```
Trustless Hub version v0.17.0 darwin/amd64 -build date: 2021-07-15T18:34:28Z
```
