...
- [TriggerPortal](./intents/TriggerPortal): An easy to use frontend UI to submit actions
...
Intento leverages a combination of the Cosmos stack and IBC to provide a seamless experience for action processing. Users, developers and organisations can orchestrate complex sets of actions, ranging from simple automated payments to sophisticated interchain operations, all composed and executed from the Intento processing chain. By integrating with the IBC protocol on a deep level, Intento not only automates from within a single blockchain but also from and to different blockchains, offering a general purpose solution.

Find out more about use cases in the [use cases section](./background/use-cases).


![pillars](./images/pillars.png)
The strength of Intento is within the pillars above. In order to automate actions in blockchain currently, these pillars are challenges or not yet achieved. These pillars make Intento uniquely positioned as the best intent processing solution for DeFi.

1. **Self-Custodial**
By utilizing programmed accounts on an action level, Intento enables fully self-custodial execution in a secure manner. This ensures a completely sovereign processing of your actions and conditions. By unlocking self-custody, we enhance security, transparency, and trust, allowing users to execute their intentions confidently and autonomously. With Intento, your blockchain experience is not just about participation, it's about freedom and sovereignty.
2. **Secure on-chain**
...
- [Cosmonaut GPT - your helping hand in building intent-based actions](https://chatgpt.com/g/g-cRhoPo6YH-cosmonaut/)
