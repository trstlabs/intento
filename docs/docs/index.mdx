...
- [Intento Portal](./guides/portal/overview): An easy to use frontend UI to submit flows
...
- Privileged Execution: Execute actions on your account securely via an uncontrollable, trustless address and granting permissions to it.
...
Find out more about use cases in the [use cases section](./getting-started/use-cases).
