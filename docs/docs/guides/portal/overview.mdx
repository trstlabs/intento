...
- **Set start time** _(optional)_: when the first run begins. When set to Now, it will insert 10 minutes from the time you hit Now button. When set to None, the first interval is as the initial delay.
