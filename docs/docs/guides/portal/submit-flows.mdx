---
sidebar_position: 9
title: Submission Page for Integrators
...
Let users sign up for alerts, return flow, redirect back to your site, all possible via the /submit page.
This page supports custom themes via logo and colors.
...
* **`hostConnectionId?: string`**
  *Optional.* Similar to `connectionId`, but specifically for flows executed by a Trustless Agent.
