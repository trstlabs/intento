...
title: Fee Structure
description: Understanding the fee model and cost structure for Intento transactions
---
...
When using a **Trustless Agent**, there's an additional fee charged **per execution**. This is set by the fee admin of the Trustless Agent.
...
```
GET /intento/intent/v1/trustless-agent/{address}
```

**LCD URL:**
[https://lcd.intento.zone/swagger/#get-/intento/intent/v1/trustless-agent/-address-](https://lcd.intento.zone/swagger/#get-/intento/intent/v1/trustless-agent/-address-)
