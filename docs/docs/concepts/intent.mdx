...
| `TrustlessAgent`         | `string`                            | Uncontrollable account that executes on a host chain on your behalf                              | ✔️       |
| `TrustlessAgentFeeLimit` | `cosmos.base.v1beta1.Coin`          | A limit of the fees a Trustless Agent can charge per execution, if set by creator                | ✔️       |
