...
func bindFlags(cmd *cobra.Command, v *viper.Viper) {
	cmd.Flags().VisitAll(func(f *pflag.Flag) {
		...
		_ = v.BindEnv(f.Name, fmt.Sprintf("%s_%s", "TRUST_PRICE_PROTOCOL", strings.ToUpper(strings.ReplaceAll(f.Name, "-", "_"))))
...
func Execute(rootCmd *cobra.Command) error {
	...
	executor := tmcli.PrepareBaseCmd(rootCmd, "TRUST_PRICE_PROTOCOL", app.DefaultNodeHome)
